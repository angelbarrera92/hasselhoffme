...
![Alt text](.readme_images/dell-xps15-front.png?raw=true "Linux HasselHoff"){:height="200px"} ![Alt text](.readme_images/macbookpro15_front.png?raw=true "MacOS Hasselhoff"){:height="200px"}
